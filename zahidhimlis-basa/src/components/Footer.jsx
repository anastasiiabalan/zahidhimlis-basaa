...
const Footer=()=>{
    return (
        <Container>
            <Left>
                <Logo>ТзОВ "ЗАХІДХІМЛІС"</Logo>
                <Desc>Металопрокат Україна</Desc>
                <SocialContainer>
            ...
            <Center>
                ...
                <List>
                    ...
                    <ListItem>Арматура</ListItem>
                    <ListItem>Балки</ListItem>
                    <ListItem>Круги</ListItem>
            ...
            <Right>
                ...
                <ContactItem>
                    <MailOutline style={{marginRight:"10px"}}/>Email: zahidhimlis@gmail.com
                </ContactItem>
